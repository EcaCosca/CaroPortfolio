...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne:
    'Esta es mi actualidad, una madre y una profesional, ambas potenciándose entre si. Recorriendo un camino largo y complejo logré todo lo que me propuse, equipada de la fuerza y la avidez que me caracterizan y traduciendo esto a cada area de mi vida, cada proyecto, ya sea en la radio como en la television.',
  paragraphTwo:
    'Primero nació Sobran Los Motivos, programa de entrevistas que ya lleva 16 temporadas en la región, sin dudas marcó un estilo y se convirtió en el “espacio de todas las emociones”. Luego, en octubre de 2013, pisamos la cancha estableciendo un nuevo camino en Rosario. Llegó para quedarse el “estilo CF”. Contraseña: Fútbol, un gran equipo con una capitana mujer, en una ciudad futbolera, que no es decir poco. Finalmente, llegó el magazine radial que imaginaba! Cambiamos las tardes para siempre. La compañía perfecta en la mejor radio para los futboleros: La Red. Con información, entretenimiento, mucho humor y la mejor "energía de radio", generando un vinculo único con nuestros fieles oyentes desde el 2016.',
  paragraphThree:
    'Así transcurre mi vida, entre la maternidad y un profundo amor por la profesión. Con un vector principal, la pasión como movilizador de cada uno de mis pasos. Siempre digo, casi como un mantra: “Agradecer mucho. Soñar fuerte y trabajar mucho por ello.”',
